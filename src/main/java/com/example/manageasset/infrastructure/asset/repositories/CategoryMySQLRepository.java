...
public class CategoryMySQLRepository implements CategoryRepository {
    ...
    public List<Category> getAll(QueryFilter queryFilter, String searchText) {
        ...
        return categoryJpa.findAll(pageable, searchText).stream().map(CategoryEntity::toDomain).collect(Collectors.toList());
    }
    ...
    public Category getById(Long id) {
        ...
        return categoryEntity == null ? null : categoryEntity.toDomain();
    }
    ...
    public void delete(Long id) {
        categoryJpa.delete(id, new Timestamp(Millisecond.now().asLong()));
    }
}
