...
import com.example.manageasset.domain.asset.services.UpdateAssetService;
...
public class UpdateAssetController {
    ...
    public ResponseEntity<?> update(@RequestPart("assetDto") AssetDto assetDto, @RequestPart(value = "files", required = false) List<MultipartFile> files) throws NotFoundException {
