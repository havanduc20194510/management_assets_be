...
public class DeleteLeaseContractService {
    ...
    public DeleteLeaseContractService(AssetRepository assetRepository, LeaseContractRepository leaseContractRepository, AssetLeasedRepository assetLeasedRepository) {
